<template>
    <div class="app-header header-shadow">
        ...
        <div class="app-header__mobile-menu">
            <div>
                <button type="button" color="white" class="hamburger close-sidebar-btn hamburger--elastic" v-bind:class="{ 'is-active' : isOpen }" @click="toggleMobile('closed-sidebar-open')">
